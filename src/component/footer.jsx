        ...
        <div className="px-5 w-5/6 py-8 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
            <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
              <Image src='/vercel.svg' alt='Logo' width={250} height={250}/>
            </a>
          ...
          <div className="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                <BiPhoneCall size={60} color='#1C86CE' className='flex mx-auto mb-2'/>
            ...
            <div className="flex flex-col justify-center lg:w-1/4 md:w-1/2 w-full px-4 mx-auto">
              <BiSolidStore size={60} color='#1C86CE' className='flex mx-auto mb-2'/>
              <nav className="list-none mb-10">
                <li>
                  <a className="text-gray-600 hover:text-gray-800">
                   25 oeste de Urgencias, 
                  Alajuela, San Ramón
                  </a>
                </li>
              </nav>
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            <BiCalendar size={60} color='#1C86CE' className='sm:flex sm:mx-auto mb-2'/>
              <nav className="list-none mb-10 text-center">
                <li>
                  <a className="text-gray-600 hover:text-gray-800">
                    Lunes - Viernes
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            <AiOutlineMail size={60} color='#1C86CE' className='flex mx-auto mb-2'/>
              <nav className="list-none mb-10 text-center">
                <li>
                  <a className="text-gray-600 hover:text-gray-800">
                   leonel.castro.dev@gmail.com
                  </a>
                </li>
              </nav>
            </div>
